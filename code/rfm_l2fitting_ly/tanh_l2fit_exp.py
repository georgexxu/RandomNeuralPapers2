...
from model import ShallowTanhFitter
from model import PouShallowTanhFitter
...
if __name__ == '__main__':
    ...
    for s in s_list:
        for m in m_list:
            ...
            neuron_dict_outpath = f'./logs/l2fit_neurons_s{s}_m{m}.npy'
            err_dict_outpath = f'./logs/l2fit_errs_s{s}_m{m}.npy'
            ...
            title = "L2 fitting. Tanh-${}$. $u(x_1, x_2) = \sin(m_1\pi x_1) \sin(m_2\pi x_2)$, $m_1,m_2 = {}, {}$".format(s, m, m)
            outpath = f'./figures/l2fit_tanh{s}_m{m}.jpg'
